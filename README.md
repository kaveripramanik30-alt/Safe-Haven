...
**SafeHaven AI** is an intelligent personal safety system designed to provide real-time danger detection, dynamic threat mapping, and automated emergency responses. Built for modern mobile devices, the app utilizes device sensor telemetry and simulated ML classification models to protect users in critical moments where they might be unable to manually press an SOS button.
...
2. **🗺️ AI Safe Route Recommendation**
